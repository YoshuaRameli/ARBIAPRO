    ...
    try {
        const response = await fetch('https://api.openai.com/v1/chat/completions', {
            ...
            body: JSON.stringify({
                model: "gpt-4",
                messages: [
                    {role: "user", content: `Eres un nutriolo el cual genera dietas alimenticias adecuadas a las respuestas que da el usuario, esta preguntas tu las haces tales como sexo, edad, estatura, peso, ve haciendo preguntas una a una de manera que parezca una conversación, no repitas las preguntas que vas generando`},
